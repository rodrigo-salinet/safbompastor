		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-lg text-center">
					<h2 class="text-uppercase section-heading">Agende aqui sua consulta médica ou serviço</h2>
					<h3 class="section-subheading text-muted text-primary">Preencha o formulário abaixo e envie a mensagem pra gente agilizar sua solicitação.</h3>
				</div>
			</div>
			<div class="row">
				<div class="col-lg">
